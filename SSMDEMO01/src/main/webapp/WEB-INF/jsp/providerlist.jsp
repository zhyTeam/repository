...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provider/toprovider">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/zproviderlist.js"></script>
